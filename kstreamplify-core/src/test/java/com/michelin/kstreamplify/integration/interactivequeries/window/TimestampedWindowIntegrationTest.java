...
class TimestampedWindowIntegrationTest extends KafkaIntegrationTest {
    private final TimestampedWindowStoreService timestampedWindowService = new
        TimestampedWindowStoreService(initializer);
    ...
    void shouldGetStoresAndStoreMetadata() throws IOException, InterruptedException {
        ...
        HttpRequest streamsMetadataRequest = HttpRequest.newBuilder()
            .uri(URI.create("http://localhost:8085/store/metadata/STRING_STRING_TIMESTAMPED_STORE"))
            .GET()
            .build();
    ...
    @ParameterizedTest
    @CsvSource({
        "http://localhost:8085/store/window/timestamped/WRONG_STORE/person,State store WRONG_STORE not found",
        "http://localhost:8085/store/window/timestamped/STRING_STRING_TIMESTAMPED_STORE/wrongKey,Key wrongKey not found",
        "http://localhost:8085/store/window/timestamped/WRONG_STORE,State store WRONG_STORE not found"
    })
    ...
    void shouldGetErrorWhenQueryingWrongStoreType() throws IOException, InterruptedException {
        HttpRequest request = HttpRequest.newBuilder()
            .uri(URI.create("http://localhost:8085/store/window/timestamped/STRING_AVRO_KV_STORE/person"))
            .GET()
            .build();
    ...
    void shouldGetByKeyInStringStringStore() throws IOException, InterruptedException {
        HttpRequest request = HttpRequest.newBuilder()
            .uri(URI.create("http://localhost:8085/store/window/timestamped/STRING_STRING_TIMESTAMPED_STORE/person"))
            .GET()
            .build();
    ...
    void shouldGetByKeyInStringAvroStore() throws IOException, InterruptedException {
        HttpRequest request = HttpRequest.newBuilder()
            .uri(URI.create("http://localhost:8085/store/window/timestamped/STRING_AVRO_TIMESTAMPED_STORE/person"))
            .GET()
            .build();
    ...
    @ParameterizedTest
    @CsvSource({
        "http://localhost:8085/store/window/timestamped/STRING_STRING_TIMESTAMPED_STORE/person",
    ...
    @ParameterizedTest
    @CsvSource({
        "http://localhost:8085/store/window/timestamped/STRING_STRING_TIMESTAMPED_STORE",
        "http://localhost:8085/store/window/timestamped/local/STRING_STRING_TIMESTAMPED_STORE"
    })
    ...
    @ParameterizedTest
    @CsvSource({
        "http://localhost:8085/store/window/timestamped/STRING_AVRO_TIMESTAMPED_STORE",
        "http://localhost:8085/store/window/timestamped/local/STRING_AVRO_TIMESTAMPED_STORE"
    })
    ...
    void shouldGetByKeyInStringAvroStoreFromService() {
        List<StateStoreRecord> stateStoreRecord = timestampedWindowService
    ...
    void shouldGetAllInStringAvroStoreFromService() {
        List<StateStoreRecord> stateQueryData = timestampedWindowService
        ...
        public void topology(StreamsBuilder streamsBuilder) {
            streamsBuilder
                ...
                .process(new ProcessorSupplier<String, String, String, String>() {
                    ...
                    public Set<StoreBuilder<?>> stores() {
                        StoreBuilder<TimestampedWindowStore<String, String>> stringStringWindowStoreBuilder = Stores
                            .timestampedWindowStoreBuilder(
                                Stores.persistentTimestampedWindowStore("STRING_STRING_TIMESTAMPED_STORE",
                    ...
                    public Processor<String, String, String, String> get() {
                        return new Processor<>() {
                            ...
                            public void init(ProcessorContext<String, String> context) {
                                this.stringStringWindowStore = context
            ...
            streamsBuilder
                ...
                .process(new ProcessorSupplier<String, KafkaPersonStub, String, KafkaPersonStub>() {
                    @Override
                    public Set<StoreBuilder<?>> stores() {
                        StoreBuilder<TimestampedWindowStore<String, KafkaPersonStub>> stringAvroWindowStoreBuilder =
                            Stores.timestampedWindowStoreBuilder(
                                Stores.persistentTimestampedWindowStore("STRING_AVRO_TIMESTAMPED_STORE",
                                    Duration.ofMinutes(5), Duration.ofMinutes(1), false),
                    ...
                    public Processor<String, KafkaPersonStub, String, KafkaPersonStub> get() {
                        return new Processor<>() {
                            private TimestampedWindowStore<String, KafkaPersonStub> stringAvroWindowStore;
