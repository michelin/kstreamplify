...
class KafkaStreamsWithByoUncaughtHandlerTest {
    ...
    void shouldInstantiateKafkaStreamsStarter() {
        ...
        assertEquals(starter.uncaughtExceptionHandler()
                .handle(new Exception("Bring Your Own Uncaught Exception Handler Test")),
                    REPLACE_THREAD);
    ...
    static class KafkaStreamsStarterImpl extends KafkaStreamsStarter {
        ...
        public StreamsUncaughtExceptionHandler uncaughtExceptionHandler() {
            return new ByoUncaughtExceptionHandler();
        }
    ...
    @Slf4j
    static class ByoUncaughtExceptionHandler implements StreamsUncaughtExceptionHandler {
        @Override
        public StreamThreadExceptionResponse handle(final Throwable t) {
            log.error("!Bring Your Own uncaught exception handler test!");
