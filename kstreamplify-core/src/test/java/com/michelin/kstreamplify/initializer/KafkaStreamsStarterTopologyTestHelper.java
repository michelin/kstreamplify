...
public class KafkaStreamsStarterTopologyTestHelper extends KafkaStreamsStarter {
    ...
    public void topology(StreamsBuilder streamsBuilder) {
        ...
        var enrichedStreams = streams.mapValues(KafkaStreamsStarterTopologyTestHelper::enrichValue);
        var enrichedStreams2 = streams.mapValues(KafkaStreamsStarterTopologyTestHelper::enrichValue2);
