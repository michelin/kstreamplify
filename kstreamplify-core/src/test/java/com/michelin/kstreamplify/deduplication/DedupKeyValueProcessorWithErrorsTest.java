...
class DedupKeyValueProcessorWithErrorsTest {

    private DedupKeyValueProcessorWithErrors<KafkaError> processor;
    ...
    void setUp() {
        ...
        processor = new DedupKeyValueProcessorWithErrors<>("testStore", Duration.ofHours(1));
