...
/**
 * Wrapper class for simplifying topics interactions
 * and their behaviors.
 *
...
public final class TopicWithSerde<K, V> {
     ...
     * }</pre>
     * <p>If the topic name is {@code myTopic}, at stream initialization
     * the topic name will resolve to {@code myNamespacePrefix.myTopic}</p>
     */
     ...
     * }</pre>
     * <p>If the topic name is {@code myTopic}, at stream initialization
     * the topic name wil resolve to {@code myNamespacePrefix.myTopic}</p>
     *
    ...
    /**
     * Override of the toString method, dynamically builds the topicName based
     * on Spring Boot properties for environment/application.
     *
    ...
    /**
     * Wrapper for the .table method of KafkaStreams.
     * Allows simple usage of a topic with type inference
     *
     * @param sb        The streamsBuilder
    ...
    /**
     * Wrapper for the .globalTable method of KafkaStreams.
     * Allows simple usage of a topic with type inference
     *
     * @param sb        The streamsBuilder
     * @param storeName The StoreName
    ...
    /**
     * Wrapper for the .to method of Kafka streams.
     * Allows simple usage of a topic with type inference
     *
