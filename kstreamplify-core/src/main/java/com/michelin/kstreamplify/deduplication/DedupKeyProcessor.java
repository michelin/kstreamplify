...
public class DedupKeyProcessor<V extends SpecificRecord>
    ...
    public void process(Record<String, V> record) {
        ...
        try {
            // Retrieve the matching key in the statestore and
            // return null if found (signaling a duplicate)
            ...
            processorContext.forward(ProcessingResult.wrapRecordFailure(e, record,
