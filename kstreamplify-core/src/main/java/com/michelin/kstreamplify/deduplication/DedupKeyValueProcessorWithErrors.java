 ...
 */
public class DedupKeyValueProcessorWithErrors<V extends SpecificRecord>
     ...
     */
    public DedupKeyValueProcessorWithErrors(String windowStoreName, Duration retentionWindowHours) {
